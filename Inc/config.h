...
// Control selections
//#define CTRL_TYP_SEL    2        // [-] Control type selection: COM_CTRL, SIN_CTRL, FOC_CTRL (default)
//#define CTRL_MOD_REQ    3        // [-] Control mode request: OPEN_MODE, VLT_MODE (default), SPD_MODE, TRQ_MODE. Note: SPD_MODE and TRQ_MODE are only available for CTRL_FOC!
